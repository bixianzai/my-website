        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">alex@example.com</span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">github.com/alexchen</span>
            </a>
            ...
            <div className="flex flex-col items-center gap-3 p-6 rounded-xl bg-white dark:bg-gray-800 shadow-sm">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">中国 · 深圳</span>
            </div>
          </div>
        </div>
      </section>
