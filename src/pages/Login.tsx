    ...
    <div className="min-h-svh flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
          <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">登录</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={loading} className="w-full py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 disabled:opacity-50 transition-colors">{loading ? '登录中...' : '登录'}</button>
          </form>
          <p className="mt-4 text-sm text-center text-gray-400">
            还没有账号？<Link to="/register" className="text-purple-500 hover:underline">注册</Link>
          </p>
        </div>
      </div>
    </div>
